...
if (isset($_POST['add']))
{
    ...
    {
        echo "<script>alert('There was an error adding this item');window.location = 'guests.php' </script>";
    }
}
...
<body>
<form method="post" action="addguest.php" id="editform" role="form">
    <div class="modal-body">
        ...
        <div class="form-group">
            <label>Rating
                <input id="rating" name="rating" type="number" class="rating" min=0 max=5 step=1 data-size="xs" >
            </label>
        </div>
        <div class="form-group">
            <label>Suburb</label>
